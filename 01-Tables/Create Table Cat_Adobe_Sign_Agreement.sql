...
if exists (select 1
           ...
           where  id    = object_id('Invoices')
            ...
            and   indid > 0
            and   indid < 255)
   drop index Invoices.IDX_FK_AGREEMENTSTATUS_INVOICES_FK
go

ALTER TABLE Invoices ADD	Id_Agreement_Status varchar(10)          null
GO
ALTER TABLE Invoices ADD	Document_Id			varchar(50)          null
GO
ALTER TABLE Invoices ADD	Agreement_Id        varchar(50)          null
GO
ALTER TABLE Invoices ADD	Next_Signer			varchar(50)          null
GO

create index IDX_FK_AGREEMENTSTATUS_INVOICES_FK on Invoices (
